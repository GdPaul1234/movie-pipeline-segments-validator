...
media_out_adapter = TypeAdapter(MediaOut)
media_adapter = TypeAdapter(Media)
extract_title_out_adapter = TypeAdapter(ExtractTitleOut)
...
class TestHttpApi(unittest.TestCase):
    ...
    def test_create_session(self):
        ...
        actual_session = session_adapter.validate_json(response.text)
    ...
    def test_show_video_media(self):
        ...
        actual_media = media_out_adapter.validate_json(response.text)
    ...
    def test_load_imported_segments(self):
        ...
        actual_media = media_adapter.validate_json(response.text)
        self.assertEqual(
    ...
    def test_extract_title(self):
        ...
        actual_extract_title_out = extract_title_out_adapter.validate_json(response.text)
